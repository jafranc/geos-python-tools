...
if __name__ == "__main__":
    ...
    if args.dense and args.pvd and args.solute:
        dense = Dense_Data(args.spe, args.solute[0])
        dense.process(directory=args.o[0], ifile=args.pvd[0])
    elif args.sparse and args.pvd and args.solute and args.units:
        sparse = Sparse_Data(args.spe, solubility_file=args.solute[0], units=args.units)
        sparse.process(directory=args.o[0], ifile=args.pvd[0])
